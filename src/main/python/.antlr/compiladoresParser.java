...
public class compiladoresParser extends Parser {
	...
	public static final int
		WS=1, ENTERO=2, PYC=3, COMA=4, LA=5, LC=6, PA=7, PC=8, IGUAL=9, MENOR=10, 
		MAYOR=11, MAS=12, MENOS=13, MUL=14, DIV=15, MOD=16, UMAS=17, UMENOS=18, 
		TRUE=19, FALSE=20, AND=21, OR=22, EQUI=23, DIST=24, IF=25, WHILE=26, FOR=27, 
		RETURN=28, PUBLIC=29, PRIVATE=30, VOID=31, INT=32, DOUBLE=33, CHAR=34, 
		BOOL=35, ID=36;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'>'", "'+'", "'-'", "'*'", "'/'", "'%'", "'++'", "'--'", "'true'", "'false'", 
			"'&&'", "'||'", "'=='", "'!='", "'if'", "'while'", "'for'", "'return'", 
			"'public'", "'private'", "'void'", "'int'", "'double'", "'char'", "'bool'"
		};
	}
	private static final String[] _LITERAL_NAMES = makeLiteralNames();
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "WS", "ENTERO", "PYC", "COMA", "LA", "LC", "PA", "PC", "IGUAL", 
			"MENOR", "MAYOR", "MAS", "MENOS", "MUL", "DIV", "MOD", "UMAS", "UMENOS", 
			"TRUE", "FALSE", "AND", "OR", "EQUI", "DIST", "IF", "WHILE", "FOR", "RETURN", 
			"PUBLIC", "PRIVATE", "VOID", "INT", "DOUBLE", "CHAR", "BOOL", "ID"
		};
	}
	...
	public final Llamada_funcionContext llamada_funcion() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68721049732L) != 0)) {
				{
				{
				setState(361);
				asignables();
