...
public class compiladoresLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LETRA", "DIGITO", "WS", "ENTERO", "DECIMAL", "CHARACTER", "PYC", "COMA", 
			"LA", "LC", "PA", "PC", "IGUAL", "MENOR", "MAYOR", "MAS", "MENOS", "MUL", 
			"DIV", "MOD", "UMAS", "UMENOS", "TRUE", "FALSE", "AND", "OR", "EQUI", 
			"DIST", "IF", "WHILE", "FOR", "RETURN", "PUBLIC", "PRIVATE", "VOID", 
